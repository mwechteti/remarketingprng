        ...
        this.model = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: 'Crud', icon: 'pi pi-fw pi-circle', routerLink: ['/pages/crud'] },
                    { label: 'Vehicle', icon: 'pi pi-fw pi-car', routerLink: ['/vehicle'] },
                    { label: 'address', icon: 'pi pi-fw pi-map-marker', routerLink: ['/address'] },
                    { label: 'country', icon: 'pi pi-fw pi-map', routerLink: ['/country'] },
                    { label: 'legalEntity', icon: 'pi pi-fw pi-list', routerLink: ['/legalEntity'] },
                    { label: 'legalEntityType', icon: 'pi pi-fw pi-list', routerLink: ['/legalEntityType'] },
                    { label: 'make', icon: 'pi pi-fw pi-home', routerLink: ['/make'] },
                    { label: 'model', icon: 'pi pi-fw pi-box', routerLink: ['/model'] }
