...
public class UserMapper {
    ...
    public User userDTOToUser(AdminUserDTO userDTO) {
        if (userDTO == null) {
            ...
            if(CollectionUtils.isNotEmpty(userDTO.getPortfolios())) {
                List<Portfolio> listPortfolios = new ArrayList<>();
                userDTO.getPortfolios().forEach(portfolioDTO -> listPortfolios.add(new Portfolio(portfolioDTO.getId(), portfolioDTO.getLabel())));
                user.setPortfolios(new HashSet<>(listPortfolios));
            }
            return user;
        }
    }
    ...
    private Set<Portfolio> portfoliosFromStrings(Set<String> portfoliosAsString) {
        Set<Portfolio> portfolios = new HashSet<>();

        if (portfoliosAsString != null) {
            portfolios =
                portfoliosAsString
                    .stream()
                    .map(
