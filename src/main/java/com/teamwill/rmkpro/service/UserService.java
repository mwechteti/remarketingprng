package com.teamwill.rmkpro.service;
...
import com.teamwill.rmkpro.repository.AuthorityRepository;
import com.teamwill.rmkpro.repository.UserRepository;
import com.teamwill.rmkpro.security.SecurityUtils;
import com.teamwill.rmkpro.service.dto.AdminUserDTO;
import com.teamwill.rmkpro.service.dto.UserDTO;
...
public class UserService {
    ...
    private User syncUserWithIdP(Map<String, Object> details, User user) {
        // save authorities in to sync user roles/groups between IdP and the local database
        ...
        // save account in to sync users between IdP and the local database
        ...
        if (existingUser.isPresent()) {
            ...
            user.setPortfolios(existingUser.get().getPortfolios());
        } else {
...
//        );
    ...
    private static User getUser(Map<String, Object> details) {
        ...
        // What is this piece of code? send to trash?
        //        else {
