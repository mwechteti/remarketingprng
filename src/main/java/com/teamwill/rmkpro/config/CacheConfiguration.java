...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.teamwill.rmkpro.domain.Address.class.getName());
            createCache(cm, com.teamwill.rmkpro.domain.LegalEntity.class.getName() + ".vehicles");
            createCache(cm, com.teamwill.rmkpro.domain.Address.class.getName() + ".legalEntities");
            createCache(cm, com.teamwill.rmkpro.domain.LegalEntity.class.getName() + ".addresses");
            createCache(cm, com.teamwill.rmkpro.domain.Country.class.getName());
            createCache(cm, com.teamwill.rmkpro.domain.Portfolio.class.getName());
            createCache(cm, com.teamwill.rmkpro.domain.Portfolio.class.getName() + ".portfolioItems");
            createCache(cm, com.teamwill.rmkpro.domain.PortfolioItem.class.getName());
            createCache(cm, PortfolioItemDetails.class.getName());
