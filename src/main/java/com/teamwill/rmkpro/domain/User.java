...
public class User extends AbstractAuditingEntity {
    ...
    @JsonIgnoreProperties(value = { "label", "portfolioItems"}, allowSetters = true)
    ...
    public User portfolios(Set<Portfolio> portfolios) {
        this.portfolios(portfolios);
        return this;
    }
    ...
    public User addPortfolio(Portfolio portfolio) {
        ...
        portfolio.addAssignedUser(this);
        return this;
    }

    public User removePortfolio(Portfolio portfolio) {
        this.portfolios.remove(portfolio);
        portfolio.removeAssignedUser(this);
        return this;
    }
